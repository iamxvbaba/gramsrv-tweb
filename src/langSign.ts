const lang = {
  'Login.Title': 'Sign in to Telesrv',
  ...
  'Login.Code.SentInApp': 'We have sent you a message in Telesrv\nwith the code.',
  ...
  'Login.ResetEmail.Text': 'You can change your login email if you are logged into Telesrv from another device.\n\nOtherwise, if you don\'t have access to this email, you can reset it with an **SMS** code in **%s**.',
  ...
  'Login.QR.Help1': 'Open your connected Telesrv client on your phone',
  ...
  'Login.QR.Subtitle': 'Scan with a connected Telesrv client on your phone',
